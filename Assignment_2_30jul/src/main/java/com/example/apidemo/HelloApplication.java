...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label label = new Label("Press the button to display data from API");
        Button button = new Button("Display Data");
    ...
    private void fetchDataFromApi(Label label) {
        new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> label.setText("Failed to display data"));
                ex.printStackTrace();
            }
        }).start();
    }
